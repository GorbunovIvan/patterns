...
public class CarConveyorFactory implements ConveyorFactory {
    ...
    public CarConveyorFactory(@Qualifier("carBodyMaker") BodyMaker bodyMaker,
                              @Qualifier("smallWheelsAdder") WheelsAdder wheelsAdder,
                              @Qualifier("electronicStuffing") Stuffing stuffing) {
